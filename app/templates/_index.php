...
<div class="container">
    <div class="row mt-5">
        <div class="md-form mt-0 col-12">
            ...
            <label for="casos">Número de casos positivos nos últimos 14 dias</label>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-5 js-emergency" style="display:none">
        <div class="col-12 text-center">
            <p class="pp">Com <span class="js-cases"></span> casos nos últimos 14 dias <strong><span class="js-concelho"></span></p>
    ...
    <div class="row mt-5 js-not-emergency" style="display:none">
        <div class="col-12 text-center">
            <p class="pp">Com <span class="js-cases"></span> casos nos últimos 14 dias <strong><span class="js-concelho"></span></strong></p>
